...
Usage:
	1. JSON_PATH=path/to/bdd100k_labels_images_train.json category_prevalence.py BDD JSON_PATH
	2. JSON_PATH=path/to/coco/annotations/instances_train2017.json
	category_prevalence.py COCO JSON_PATH --wanted-categories person,bike,bird,dog
...
def main():
	...
	if args.wanted_categories:
		...
		category_count = class_sieve(categories_count, wanted_categoris)
